...
\begin{enumerate}
  ...
  \item \tcbox{\textcolor{WildStrawberry}{\texttt{DO\_NOTHING}}}: this action compels the train to adhere to a continuation of its previous action; an exception to this is that while stopped, this reverses the direction of the train
